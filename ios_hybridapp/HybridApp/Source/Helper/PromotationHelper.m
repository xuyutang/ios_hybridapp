...
@implementation PromotationHelper
/**
 * 加载闪屏也广告
 */
 ...
 * 返回广告数据模型
 */
- (PromotionModel *)getPromotionItem {
    ...
    if ([fileManager fileExistsAtPath:self.lastPromotionPageFile]) {
        ...
        if (data) {
            ...
            PromotionModel *item = [PromotionModel mj_objectWithKeyValues:dict];
